              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 subpage-block">
                  <ul class="info-list">
                    ...
                    <li><span class="title">Address</span><span class="value">H3 Block Johar Town Lahore</span></li>
                    <li><span class="title">e-mail</span><span class="value"><a href="mailto:email@example.com">ammr.habib.mughal@gmail.com</a></span></li>
                  ...
                  <ul class="social-links">
                    <li><a class="tip social-button" target="_blank" href="https://www.facebook.com/ammarhabibmughal/" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                    <li><a class="tip social-button" target="_blank" href="https://www.linkedin.com/in/ammar-habib-947bb8105/" title="Linkend"><i class="fa fa-linkedin"></i></a></li> <!-- Full list of social icons: http://fontawesome.io/icons/#brand -->
                  ...
                  <div class="col-sm-6 col-md-4 subpage-block">
                    ...
                    <div class="timeline text-capitalize">
                      ...
                      <div class="timeline-event te-primary">
                        ...
                        <span class="event-description">Technology Wisedom</span>
                        <p>Responsible for working closely with the product development team to organize, manage, updated the data into database</p>
                      </div>
                    </div>
                  </div>
