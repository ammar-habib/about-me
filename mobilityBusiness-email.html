...
<!--                    <li>-->
                        <p><i class="fa fa-photo"></i>
                            <a href="https://www.dropbox.com/sh/p6hy8zzvpe1ey3x/AADSdovwk4Unb2CsQUvKMnN8a?dl=0"
                ...
                <p class="text-justify">
                    Build the Mobility Business XD base email templates design in HTML / CSS & MJML for Mailchimp email marketing campaign.
                </p>
                <!-- /Project Description -->
