    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                ...
                <a class="ajax-page-load" href="exosecure.php"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <p class="text-justify">
                    Dicta applies cutting edge machine learning and natural language processing tools to the analysis of
                    Hebrew texts. Our objective is to remove the drudgery from the study of classical and modern Hebrew
