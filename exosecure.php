    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="dicta.php"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
                <a class="ajax-page-load" href="churchbase.php"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
...
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/exosecure/exso1.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/exosecure/exso2.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/exosecure/exso3.png" alt="">-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://exosecure.com/" target="_blank">https://exosecure.com</a>
                        </p></li>
                </ul>
