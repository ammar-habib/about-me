        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    <div class="item">
                        <img src="images/portfolio/shipm8.png" alt="">
                    </div>
                </div>
                <!--
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="http://shipm8.com/" target="_blank">www.shipm8.com</a></p></li>
                </ul>

                <p class="text-justify">This is shipping service provided company website. This is a team base project.</p>
                <!-- /Project Description -->
