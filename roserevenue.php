...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://roserevenue.com/"
                                                          target="_blank">https://roserevenue.com/</a>
                        </p></li>
                </ul>

                <p class="text-justify">
                    Rose Revenue is Platform which Help you Create a Simple Approach to Sales Automation so u never miss a beat with you clients!
                </p>
                <p class="text-justify">
