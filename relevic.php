        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="portfolio-page-image">
                    <img src="images/portfolio/relevicAll.png" alt="relevic">
                </div>
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <p class="text-justify">
                    Relevic is a embeddable web personalization & A/B testing editor
                </p>
                <p class="text-justify">

                    Build Relevic Sketch base dashboard designs in HTML5, CSS3, and React JS with the help of React-bootstrap.
                    All screens are fully responsive and compatible with all major browser
                </p>
                <!-- /Project Description -->
