    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="greenectus.php"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
                <a class="ajax-page-load" href="alfanar.php"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://techmatetech.com/"
                                                          target="_blank">https://techmatetech.com</a>
                        </p></li>
                </ul>
