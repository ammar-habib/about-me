    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                ...
                <a class="ajax-page-load" href="cac.php"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
...
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/fantaztech/fantez1.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/fantaztech/fantez2.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="item">-->
<!--                        <img src="images/portfolio/fantaztech/fantez3.png" alt="">-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://fantaztech.com/" target="_blank">https://fantaztech.com/</a>
                        </p></li>
                </ul>
