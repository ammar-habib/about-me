    ...
    <div class="ajax-page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <p class="text-justify">BugByte Studio is a technology group that strives to produce high-quality mobile
                                        apps & games.</p>
                <p class="text-justify">
                    Build BugByte Studio XD base Landing page design into HTML5, CSS3 and JS with the help of
                    Bootstrap 4.
                    It is fully responsive pixel perfect and compatible with all major browser.
                </p>
                <!-- /Project Description -->
