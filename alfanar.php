    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="techmatetech.php"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
...
<!--                </script>-->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://www.alfanarrestaurant.com/uae/"
                                                          target="_blank">https://www.alfanarrestaurant.com/uae/</a>
                        </p></li>
                </ul>
